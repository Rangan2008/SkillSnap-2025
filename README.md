...
- **Community-Driven Courses** aligned with career goals
...
- ✅ Phase-based structured learning
...
### 📊 **User Dashboard**
- ✅ Resume upload history (paginated)
- ✅ Analysis overview with metrics
...
|---------|---------|---------|
| Next.js | 16.0.10 | SSR & API routes |
...
|-------|--------|--------|
| Next.js API Routes | 16.0.10 | Backend |
| Google Gemini AI | v1 | AI analysis |
| Firebase Auth | 12.7.0 | Authentication |
| Firebase Admin SDK | 12.7.0 | Server ops |
